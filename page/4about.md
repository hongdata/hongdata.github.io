...
학습한 내용을 정리하고 기록해둘 필요를 느끼게 되었습니다.
그런데 제가 알고있는 내용, 제가 공부한 내용들이 단순히 저 혼자만을 위한 내용으로 끝나지 않고 
저 뿐만이 아닌 누군가에게도 도움이 되었으면 하는 바램으로 블로그를 개설하게 되었습니다.

## Contact info

* email：hongodd@gmail.com
